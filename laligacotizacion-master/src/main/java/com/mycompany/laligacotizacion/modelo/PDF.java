...
public class PDF {
    ...
    public String fecha;
    //Decimales se ocupa para mostrar de despues de las letras los decimales /100 y se calcula a partir de totalivaS
    public String decimales;
    //Esta variable se calcula a partir del totaliva y le da un formato especifico para mostrarlo en el pdf

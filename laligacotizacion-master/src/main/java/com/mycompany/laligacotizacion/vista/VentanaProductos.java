...
public class VentanaProductos extends javax.swing.JPanel {
    ...
    //Aqui es el texto que mostraran los botones correspondientes
    ...
    public VentanaProductos() {
        ...
        //Aqui le asigno el nombre a mis botones para despues poder identificar cual elimina y cual modifica para poder realizar la acción necesaria
        miButton.setName("e");
        miButton1.setName("m");
        initComponents();
    ...
    private void t_productosMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_t_productosMouseClicked
        ...
        //aqui obtengo el int de la columna y la fila en la que hice clic
        column = t_productos.getSelectedColumn();
        row = t_productos.getSelectedRow();
        
        //verifico que la columna esta dentro de los limites de la tabla
